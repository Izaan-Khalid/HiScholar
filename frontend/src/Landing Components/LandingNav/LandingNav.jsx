...
export const LandingNav = () => {
  return (
    <nav className='landing-nav flex justify-between items-center bg-blue-900 w-full '>
      ...
      <a href='/login'><button class="relative py-2 px-8 text-black text-base font-bold overflow-hidden bg-white rounded-full transition-all duration-400 ease-in-out 
